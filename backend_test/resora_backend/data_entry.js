...
async function insertUsers() {
  try {
    ...
    const users = [
      ...
      // =========================
      {
        email: "hina.i@university.edu",
        role: "Teacher",
        referenceQuery: `
          SELECT teacher_id AS reference_id, name
          FROM Teachers
          WHERE email = 'hina.i@university.edu'
        `
      },
      {
        email: "a.qadeer@university.edu",
        role: "Teacher",
        referenceQuery: `
          SELECT teacher_id AS reference_id, name
          FROM Teachers
          WHERE email = 'a.qadeer@university.edu'
        `
      },
      {
        email: "aamir.w@university.edu",
        role: "Teacher",
        referenceQuery: `
          SELECT teacher_id AS reference_id, name
          FROM Teachers
          WHERE email = 'aamir.w@university.edu'
        `
      },
